...
public class BoardAdjTargetTest306 {
	...
	public void testTargetsOccupied() {
		...
		board.getCell(15, 7).setOccupation(true);
		board.calcTargets(board.getCell(13, 7), 4);
		board.getCell(15, 7).setOccupation(false);
		Set<BoardCell> targets = board.getTargets();
		...
		board.getCell(12, 20).setOccupation(true);
		board.getCell(8, 18).setOccupation(true);
		board.calcTargets(board.getCell(8, 17), 1);
		board.getCell(12, 20).setOccupation(false);
		board.getCell(8, 18).setOccupation(false);
		targets= board.getTargets();
		assertEquals(3, targets.size());
		assertTrue(targets.contains(board.getCell(7, 17)));	
		...
		board.getCell(12, 15).setOccupation(true);
		board.calcTargets(board.getCell(12, 20), 3);
		board.getCell(12, 15).setOccupation(false);
		targets= board.getTargets();
