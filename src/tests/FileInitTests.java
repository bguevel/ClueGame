...
public class FileInitTests {
	...
	public void testRoomLabels() {
		...
		assertEquals("Alderson", board.getRoom('A').getName() );
		assertEquals("Green Center", board.getRoom('G').getName() );
		assertEquals("Hill Hall", board.getRoom('H').getName() );
		assertEquals("Jackson", board.getRoom('J').getName() );
		assertEquals("Spruce", board.getRoom('S').getName() );
	}
	...
	public void testRooms() {
		...
		room = board.getRoom( cell ) ;
		assertTrue( room != null );
		assertEquals( room.getName(), "Green Center" ) ;
